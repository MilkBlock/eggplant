            ...
            LayoutSpec::Hierarchical {
                ...
                if let Some(o) = orientation {
                    st.orientation = match o {
                        HierOrientationSpec::TopDown => LayoutHierarchicalOrientation::TopDown,
                        HierOrientationSpec::LeftRight => LayoutHierarchicalOrientation::LeftRight,
                    };
                }
                // Trigger re-run once
                st.triggered = false;
    ...
    pub fn from_ui_hier_state(ui: &mut egui::Ui) -> LayoutSpec {
        ...
        LayoutSpec::Hierarchical {
            ...
            orientation: Some(match st.orientation {
                LayoutHierarchicalOrientation::TopDown => HierOrientationSpec::TopDown,
                LayoutHierarchicalOrientation::LeftRight => HierOrientationSpec::LeftRight,
            }),
        }
    }
}
