...
use eggplant_egui_graphs::ForceAlgorithm;
use eggplant_egui_graphs::FruchtermanReingold;
use eggplant_egui_graphs::FruchtermanReingoldState;

fn make_graph(num_nodes: usize, num_edges: usize) -> Graph {
    let mut g = StableGraph::default();
    for _ in 0..num_nodes {
        g.add_node(ViewNode::default());
    }
