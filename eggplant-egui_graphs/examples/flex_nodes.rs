...
use eggplant_egui_graphs::{
    DefaultEdgeShape, DefaultGraphView, Graph, GraphView, SettingsInteraction,
...
pub struct FlexNodesApp {
    g: Graph<NodeShapeFlex, DefaultEdgeShape>,
    label_input: String,
...
impl FlexNodesApp {
    ...
    fn render(&mut self, ctx: &Context) {
        ...
        CentralPanel::default().show(ctx, |ui| {
            let widget: &mut GraphView<'_, NodeShapeFlex, DefaultEdgeShape> =
                &mut GraphView::<_, _, _, _>::new(&mut self.g).with_interactions(
...
mod node {
    use eggplant_egui_graphs::{DisplayNode, DrawContext, NodeProps};
    ...
    impl<Ty: EdgeType> DisplayNode<Ty> for NodeShapeFlex {
