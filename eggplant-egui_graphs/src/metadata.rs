...
const KEY: &str = "eggplant_egui_graphs_metadata";
...
impl Bounds {
    pub fn compute_next<Nd: DisplayNode<Directed>>(&mut self, n: &Node<Directed, Nd>) {
...
impl Metadata {
    ...
    pub fn process_bounds<Nd: DisplayNode<Directed>>(&mut self, n: &Node<Directed, Nd>) {
