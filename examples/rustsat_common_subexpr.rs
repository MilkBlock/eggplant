...
fn main() {
    ...
    let ruleset = RustsatCseTx::new_ruleset("union_common_subexpr_roots_for_rustsat_demo");
    RustsatCseTx::add_rule(
        "union_common_subexpr_roots_for_rustsat_demo",
        ruleset,
        || {
    ...
    .expect("rustsat extraction should succeed on the common-subexpression demo");
