...
pub struct AnimatedNodesApp {
    g: Graph<NodeShapeAnimated, DefaultEdgeShape>,
}
...
impl App for AnimatedNodesApp {
    fn update(&mut self, ctx: &Context, _: &mut eframe::Frame) {
        egui::CentralPanel::default().show(ctx, |ui| {
            ui.add(
                &mut GraphView::<NodeShapeAnimated, DefaultEdgeShape>::new(&mut self.g)
                    .with_navigations(
...
mod node {
    ...
    use egui::{
        Color32, FontFamily, FontId, Pos2, Rect, Shape, Stroke, Vec2, emath::Rot2,
        epaint::TextShape,
    };
    ...
    impl<Ty: EdgeType> DisplayNode<Ty> for NodeShapeAnimated {
