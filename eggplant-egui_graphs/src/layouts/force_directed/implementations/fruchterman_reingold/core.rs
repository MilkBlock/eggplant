...
pub(crate) fn compute_repulsion<Nd: DisplayNode<Directed>, Ed: DisplayEdge<Directed, Nd>>(
    g: &Graph<Nd, Ed>,
    indices: &[NodeIndex],
    disp: &mut [Vec2],
    k: f32,
...
pub(crate) fn compute_attraction<Nd: DisplayNode<Directed>, Ed: DisplayEdge<Directed, Nd>>(
    g: &Graph<Nd, Ed>,
    indices: &[NodeIndex],
    disp: &mut [Vec2],
    k: f32,
...
pub(crate) fn apply_displacements<Nd: DisplayNode<Directed>, Ed: DisplayEdge<Directed, Nd>>(
    g: &mut Graph<Nd, Ed>,
    indices: &[NodeIndex],
    disp: &[Vec2],
    dt: f32,
...
//     use super::*;
//     use crate::{
//         DefaultEdgeShape, DefaultNodeShape,
//         elk_types::{ElkEdge, ElkNode},
//         to_graph,
//     };
//     use egui::{Pos2, Rect};
...
//     fn make_graph(num: usize) -> Graph<DefaultNodeShape, DefaultEdgeShape> {
//         let mut g: StableGraph<ElkNode, ElkEdge> = StableGraph::default();
//         // for _ in 0..num {
//         //     g.add_node();
//         // }
