...
fn main() {
    eprintln!("nncase_transpose_timeline_export requires --features rustsat-extract");
}
...
mod real {
    ...
    pub fn workload_spec() -> BenchmarkWorkloadSpec<'static> {
        nncase_transpose_microbenchmark::workload_spec()
    }
    ...
    {
        nncase_transpose_microbenchmark::parse_timeline_args(args)
    }
    ...
    pub fn main() -> Result<(), Box<dyn std::error::Error>> {
        ...
        let mut report = nncase_transpose_microbenchmark::run_extract_timeline_with_options(
        ...
        let report_title = "Nncase Transpose Timeline";
